...
function prix_objets_periodes_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_po_periodes'] = array(
		'type' => 'po_periode',
		'principale' => 'oui',
		'table_objet_surnoms' => array('poperiode'), // table_objet('po_periode') => 'po_periodes' 
		'field'=> array(
		...
		'date' => 'date',
		'champs_editables'  => array('titre', 'descriptif', 'type', 'date_debut', 'date_fin', 'jour_debut', 'jour_fin', 'jour_nombre'),
		'champs_versionnes' => array('titre', 'descriptif', 'type', 'date_debut', 'date_fin', 'jour_debut', 'jour_fin', 'jour_nombre'),
