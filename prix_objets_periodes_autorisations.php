<?php
/**
 * Définit les autorisations du plugin Prix objets par périodes
 *
 * @plugin     Prix objets par périodes
 * @copyright  2018
 * @author     Rainer Müller
 * @licence    GNU/GPL v3
 * @package    SPIP\Prix_objets_periodes\Autorisations
 */
 ...
 * @pipeline autoriser */
function prix_objets_periodes_autoriser() {
}
...
/**
 * Autorisation de voir un élément de menu (poperiodes)
 *
...
/**
 * Autorisation de créer (poperiode)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
...
/**
 * Autorisation de voir (poperiode)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
...
/**
 * Autorisation de modifier (poperiode)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
...
/**
 * Autorisation de supprimer (poperiode)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
